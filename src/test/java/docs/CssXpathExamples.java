...
public class CssXpathExamples {
    ...
    void cssXpathExamples(){
        ...
        // Если есть все <input type="email" class="inputtext login_form_input_box" name="email" id="email" data-testid="royal_email">

        $("[data-testid=\"royal_email\"]").setValue("some@mailmail.bf");
        $(by("data-testid", "royal_email")).setValue("some@email.com");

        // Если нет data-testid <input type="email" class="inputtext login_form_input_box" name="email" id="email">
        ...
        // Если нет ID <input type="email" class="inputtext login_form_input_box" name="email">
        ...
        // Если нет ID <input type="email" class="inputtext login_form_input_box">
